...
```{r}
new_model <- lm(career_after_15_month ~ . - INSTITUTION_CODE, data = newdata_scale)
vif(new_model)
step(new_model)
```
...
# hyperparameter for the betas and tau
mu0 = 0; sigma02 = 10; a = 0.1; b = 0.1; df = 9
...
res.sample.robust <- coda.samples(model.robust, variable.names = c("beta", "sigma2"), n.iter = 25000,
                thin = 50,   progress.bar = "none")
```
